...
(function () {
  ...
  const DICT = {
    ar: {
      ...
      placeholder_name: "مثال: أحمد محمد علي",
      ...
      help_name: "تجميع ملف استخباراتي (Dossier) من الويب",
      quota: "بحوثك اليوم",
      pro: "برو",
      login: "تسجيل الدخول",
      register: "إنشاء حساب",
    ...
    en: {
      ...
      help_name: "Build an intelligence dossier from the web",
